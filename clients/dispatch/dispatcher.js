...
export function createDispatchContext(filePath, cwd, pi) {
 ...
 */
export async function dispatchForFile(ctx, options = {}) {
 ...
 */
async function runRunnerGroup(ctx, runnerIds, mode) {
 ...
 * Run a single runner
 */
async function runSingleRunner(ctx, runnerId) {
 ...
 */
export async function checkArchitecturalRules(ctx, rules) {
    if (!ctx.kind)
        return "";
    let output = "";
    try {
